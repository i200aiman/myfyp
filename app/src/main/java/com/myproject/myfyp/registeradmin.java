                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            sendUserData();
                            fAuth.signOut();
                            Toast.makeText(registeradmin.this,"Successfully Registered, Upload Complete!", Toast.LENGTH_SHORT).show();
                            finish();
        ...
        if(firebaseUser != null){
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        sendUserData();
                        Toast.makeText(registeradmin.this,"Successfully Registered, Verification Email has been sent!", Toast.LENGTH_SHORT).show();
                        fAuth.signOut();
                        finish();
                        startActivity(new Intent(registeradmin.this,loginadmin.class));
                    ...
                    {
                        Toast.makeText(registeradmin.this,"Verification mail hasnt been sent!",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUserData()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(registeradmin.this,"Upload Fail", Toast.LENGTH_SHORT).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(registeradmin.this,"Upload Successful", Toast.LENGTH_SHORT).show();
            }
        });
